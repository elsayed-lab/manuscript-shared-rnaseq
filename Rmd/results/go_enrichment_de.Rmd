...
go_results <- foreach(contrast=names(sig_genes), .packages=c('goseq')) %dopar% {
    ...
    # Skip contrasts with no differentially expressed genes
...
# https://economics.wordpress.com/2010/07/12/remove-null-elements-from-a-list-in-r/
...
if (CONFIG$include_tables) {
    print_enrichment_results(go_results, de_sets, 'GO terms', go_term_id_mapping)
}
```
