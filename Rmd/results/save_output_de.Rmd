...
raw_counts_outfile <- file.path(output_dir, sprintf('%s_counts_raw.csv', 
                                                    CONFIG$analysis_name)) 
final_counts_outfile <- file.path(output_dir, sprintf('%s_counts_final.csv', 
                                                      CONFIG$analysis_name))

write.csv(exprs(de_counts$raw), file=raw_counts_outfile, quote=FALSE)
