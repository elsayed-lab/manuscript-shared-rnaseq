...
if (CONFIG$pathogen == "L. major") {
    ...
    secreted_proteins     <- file.path(input_dir, "TriTrypDB-9.0_LmajorFriedlin_SignalP.csv")
    membrane_proteins     <- file.path(input_dir, "TriTrypDB-9.0_LmajorFriedlin_TMHMM.csv")
    ...
    go_term_mapping       <- file.path(input_dir, "TriTrypDB-28_LmajorFriedlin_go_terms.csv")
} else if (CONFIG$pathogen == "T. cruzi") {
    orf_counts            <- file.path(input_dir, "TriTrypDB-8.0_TcruziCLBrenerEsmeraldo_ORF_counts.txt")
    secreted_proteins     <- file.path(input_dir, "TriTrypDB-9.0_TcruziCLBrenerEsmeraldo-like_SignalP.csv")
    membrane_proteins     <- file.path(input_dir, "TriTrypDB-9.0_TcruziCLBrenerEsmeraldo-like_TMHMM.csv")
    ...
    go_term_mapping       <- file.path(input_dir, "TriTrypDB-28_TcruziCLBrenerEsmeraldo-like_go_terms.csv")
} else if (CONFIG$pathogen == "T. brucei") {
    go_term_mapping       <- file.path(input_dir, "TriTrypDB-30_TbruceiTREU927_go_terms.csv")
}
```
...
if (CONFIG$pathogen %in% c("L. major", "T. cruzi")) {
    ...
    colnames(multicopy_ch_counts) <- c("Number of genes")
