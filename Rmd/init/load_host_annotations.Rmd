...
`citep(c('10.1186/1471-2164-10-22', '10.1038/nprot.2009.97'))` to retrieve ENSEMBL
...
# 1. For Human, hg19 must be used instead of hg38 (hg38 not supported yet)
# 2. Because the annotations have not been filtered to remove ncRNAs, many of
# the genes associated with lncRNAs, etc. will not have a length associated
# with them.
